...
def main():
    ...
    parser.add_argument('--input_wavs_dir', default='/home/hiddenleaf/ARYAN_MT22019/experiments/test_dir/')
    parser.add_argument('--output_dir', default='/home/hiddenleaf/ARYAN_MT22019/experiments/hifiQGANV3')
